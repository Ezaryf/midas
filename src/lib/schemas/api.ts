...
export const tradeSignalSchema: z.ZodType<TradeSignal> = z.object({
  ...
  execution_mode: z.enum(["normal", "forced"]).optional(),
  forced_from_hold: z.boolean().optional(),
  bypassed_blockers: z.array(z.string()).optional(),
  source_candidate_stage: z.enum(["filtered", "raw"]).optional(),
...
export const persistedConfigSchema: z.ZodType<MidasConfig> = z.object({
  ...
  minLotSize: z.number(),
  maxLotSize: z.number(),
  minStopDistancePoints: z.number(),
  partialCloseEnabled: z.boolean(),
  partialClosePercent: z.number(),
  breakevenEnabled: z.boolean(),
  breakevenBufferPips: z.number(),
  trailingStopEnabled: z.boolean(),
  trailingStopDistancePips: z.number(),
  trailingStopStepPips: z.number(),
  timeExitEnabled: z.boolean(),
  exitBeforeNewsMinutes: z.number(),
  exitBeforeWeekendHours: z.number(),
});
